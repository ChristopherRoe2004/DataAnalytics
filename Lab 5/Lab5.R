...
svm_regressor <- svm(PRICE ~ PROPERTYSQFT, data = train, kernel = "radial", 
                     cost = 1, gamma = 0.1)
...
par(mfrow = c(1, 2))
plot(test$PRICE, svm_preds, main = "SVM: Predicted vs Actual", 
     xlab = "Actual Price", ylab = "Predicted Price", 
     col = "blue", pch = 19)
abline(0, 1, col = "red")

plot(test$PRICE, linear_preds, main = "Linear: Predicted vs Actual", 
